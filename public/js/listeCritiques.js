    ...
    try {
        ...
        data.forEach(critique => {
            ...
            tr.innerHTML = `
                ...
                <td>
                    <a class="btn-link" href="/editCritiques.html?id=${critique.critique_id}">Modifier</a>
                    <button class="danger" onclick="supprimerCritique(${critique.critique_id})">Supprimer</button>
                </td>
            `;
